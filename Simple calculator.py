...
sub = Button(ui,activebackground='#ffe46b', bg="#d0c6f5", text="-", padx=16, pady=15, command=lambda: substraction("-")).grid(row=5, column=3)
mul = Button(ui,activebackground='#ffe46b', bg="#d0c6f5", text="x", padx=16, pady=15, command=lambda: multiplication("x")).grid(row=4, column=3)
div = Button(ui,activebackground='#ffe46b', bg="#d0c6f5", text="/", padx=16, pady=8, command=lambda: division("/")).grid(row=3, column=3)
cls = Button(ui,activebackground='#ff4d4d',bg="#6699ff", text="CLR", padx=15, pady=8, command= clear).grid(row=3, column=0)
...
bdot = Button(ui,activebackground='#73f5d7', bg="#f5f0f0", text=".", padx=20, pady=15, command=lambda: insrt(".")).grid(row=7, column=2)
...
pow = Button(ui,activebackground='#ffe46b', bg="#d0c6f5", text="pow", padx=12, pady=8, command=lambda: power("pow")).grid(row=3, column=2)
